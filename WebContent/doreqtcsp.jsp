  ...
  <nav id="mainav" class="hoc clear"> 
    <!-- ################################################################################################ -->
     <ul class="clear">
      ...
      <li class="active"><a href="doreqtcsp.jsp">Upload File</a></li>
  ...
  <main class="hoc container clear"> 
    ...
    <div class="content three_quarter first"> 
      ...
      <div id="comments">      
        ...
        <form action="doreqcsp1.jsp" method="post">
          <div class="one_third first">
            <label for="name">Public Key<span>*</span></label>
            <input type="text" name="pk" id="name" size="22" required>
          </div>
          <div class="one_third">
            <label for="email">Secrete Key<span>*</span></label>
            <input type="password" name="sk" id="name" size="22" required>
          </div>
          <div class="one_third">
            <label for="url">File Name</label>
            <input type="text" name="fname" id="name" size="22">
          </div>
          <div>
