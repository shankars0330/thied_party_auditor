  ...
  <nav id="mainav" class="hoc clear"> 
    <!-- ################################################################################################ -->
     <ul class="clear">
      ...
      <li class="active"><a href="doreqttpa.jsp">Request To TPA</a></li>
      ...
      <div id="comments">      
        ...
        <form action="doreqcsp1.jsp" method="post">
          <div class="one_third first">
            ...
            <input type="text" name="pk" id="name" value="<%= (int) (Math.random() * 1000) %>" size="22" required>
          </div>
          <div class="one_third">
            <label for="email">Secrete Key<span>*</span></label>
            <input type="password" name="sk" id="name" value="<%= (int) (Math.random() * 1000) %>" size="22" required>
          </div>
          <div class="one_third">
            <label for="url">File Name</label>
            <input type="text" name="fname" id="name" value="" size="22">
          </div>
          <div>
