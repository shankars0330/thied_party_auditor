...
<div class="wrapper row2">
  <nav id="mainav" class="hoc clear"> 
    ...
    <ul class="clear">
      ...
      <li><a href="dokeyreqtcsp.jsp">Request to CSP</a></li>
      <li><a href="dorestcsp.jsp">CSP Response</a></li>
      <li><a href="doreqtcsp.jsp">Upload File</a></li>
      <li class="active"><a href="dovf.jsp">View File</a></li>
      <li><a href="doef.jsp">Edit File</a></li>
...
<div class="wrapper row3">
  ...
  <table class="responsive-table">
    ...
    PreparedStatement ps=con.prepareStatement("select oid,oname,omail,publickey,secretkey,filename,file,date,status from upload where oid='"+aa+"'");
    ...
    while(rs.next())
     ...
     %>
        ...
        <td data-title="Budget" data-type="currency"><%=rs.getString(8) %></td>
        <td data-title="Budget" data-type="currency"><%=rs.getString(9) %></td>
        <td data-title="Budget" data-type="currency"><a href="dovf1.jsp?id=<%=rs.getString(1) %>" style="text-decoration: underline;">view</a></td>
      </tr>
    				 <%
