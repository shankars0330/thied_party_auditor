    ...
    <div class="content three_quarter"> 
      ...
      <div id="comments">
        ...
        <%
        	...
        	String c=null,d=null,e=null,s=null,g=null;
        	System.out.println("oid=="+a);
        	System.out.println("fileid=="+b);
        	Connection conn=databasecon.getconnection();
        	String sql="select oname,omail,secretkey,filename,AES_DECRYPT(file,'key') from upload where oid='"+a+"' && publickey='"+b+"'";
        ...
        <div class="one_third first">
          ...
          <div class="one_third first">
           ...
           <div class="one_third">
            ...
            <input type="text" name="fname" id="name" value="<%=b %>" size="22">
          </div>
           <div class="one_third">
