  ...
  <nav id="mainav" class="hoc clear"> 
    <!-- ################################################################################################ -->
     <ul class="clear">
      ...
      <li class="active"><a href="register1.jsp">Data Owners</a></li>
...
<div class="wrapper row3">
  ...
  <table class="responsive-table">
    <caption>Data Owners Registration Table</caption>
    <thead>
      <tr>
        <th scope="col">ID</th>
    ...
    while(rs.next())
     ...
     %>
        ...
        <td data-title="Domestic Gross" data-type="currency"><%=rs.getString(5) %></td></tr>
    				 <%
