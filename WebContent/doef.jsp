...
<div class="wrapper row3">
  ...
  <table class="responsive-table">
    ...
    PreparedStatement ps=con.prepareStatement("select oid,oname,id,publickey,filename,date,status from upload where oid='"+aa+"' and oname='"+bb+"'");
    ...
    while(rs.next())
     ...
     %>
        ...
        <a href="update.jsp?oid=<%=rs.getString(1) %>&&fid=<%=rs.getString(3) %>" style="text-decoration: underline;">Edit</a>
        <a href="delete.jsp?oid=<%=rs.getString(1) %>&&fid=<%=rs.getString(3) %>" style="text-decoration: underline;">Delete</a></td>
      </tr>
    				 <%
